...
**Endpoint:** `GET /api/website/settings/notifications`  
...
**URL:** `https://api.foodly.pro/api/website/firebase-messaging-sw.js`

```javascript
if ('serviceWorker' in navigator) {
    navigator.serviceWorker.register('/api/website/firebase-messaging-sw.js')
        .then((registration) => {
